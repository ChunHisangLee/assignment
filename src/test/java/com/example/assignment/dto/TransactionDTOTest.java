...
class TransactionDTOTest {
  ...
  void setUp() {
    ...
    objectMapper.disable(
        SerializationFeature.WRITE_DATES_AS_TIMESTAMPS); // Ensure dates are written as strings
  }
  ...
  void testSerialization() throws Exception {
    ...
    BTCPriceHistoryDTO btcPriceHistoryDTO =
        BTCPriceHistoryDTO.builder().id(1L).price(450.0).timestamp(transactionTime).build();
