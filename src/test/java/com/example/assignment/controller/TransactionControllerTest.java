...
class TransactionControllerTest {
  ...
  void testBuyBtc() throws Exception {
    ...
    when(transactionService.createTransaction(
            any(CreateTransactionRequest.class), eq(TransactionType.BUY)))
    ...
    verify(transactionService, times(1))
        .createTransaction(any(CreateTransactionRequest.class), eq(TransactionType.BUY));
  }
  ...
  void testSellBtc() throws Exception {
    ...
    when(transactionService.createTransaction(
            any(CreateTransactionRequest.class), eq(TransactionType.SELL)))
        .thenReturn(transactionDTO);
    ...
    verify(transactionService, times(1))
        .createTransaction(any(CreateTransactionRequest.class), eq(TransactionType.SELL));
  }
