...
class JwtAuthenticationFilterTest {
  ...
  void shouldAuthenticateRequest_WhenValidTokenProvided() throws ServletException, IOException {
    ...
    request.addHeader(
        SecurityConstants.AUTHORIZATION_HEADER, SecurityConstants.BEARER_PREFIX + token);
    ...
    assertThat(authInContext).isNotNull().isEqualTo(authentication);
  }

  @Test
  void shouldNotAuthenticateRequest_WhenInvalidTokenProvided()
